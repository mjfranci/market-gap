...
def get_keyword_data(keywords, timeframe='now 7-d', geo='US'):
...
Examples:
  ...
  python trend_research.py --keywords "fitness" --output results.json
    ...
    parser.add_argument('--geo', default='US',
                        help='Geographic region (default: US for United States)')
    parser.add_argument('--output', '-o',
                        help='Save results to JSON file')
    parser.add_argument('--country', default='united_states',
                        help='Country for trending searches (default: united_states)')
